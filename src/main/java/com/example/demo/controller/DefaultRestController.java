...
public class DefaultRestController {
    ...
    public Map<String, Object> paramTest(@RequestParam Map<String, Object> map) {
        ...
        System.out.println("first put : "+map_result);
        map_result.put("item2", map.get("item2"));
        System.out.println("second put : "+map_result);
        map_result.put("item3", map.get("item3"));
        System.out.println("third put : "+map_result);
        map_result.put("item4", map.get("item4"));
        System.out.println("fourth put : "+map_result);
        a_list.add("sum : "+sum);
        /*a_list.add("11");
        a_list.add("22");
        a_list.add("33");
